...
- **Explicit actor APIs**. Java integrations can resolve ownership and read immutable individual snapshots for online or offline actors. Fresh offline contexts also support revocation with attributable cascades and refunds. Legacy UUID team queries retain their meaning. See the [API contract](DOCUMENTATION.md#151-progressivestagesapi).
