...
| P001-TASK-003 | CORE-REQ-004 | Replace ambiguous labels with Stage name, Stage icon and Required stages plus concise Minecraft style hover/focus tooltip help and examples; expose entry allowed, independent protections and signed priority sourced from IF-001/IF-002. Preserve advanced/source editing. | P001-TASK-001, IF-001, IF-002, FIND-006 | Accessible form controls and source-aware effective priority display. | `components/ui.tsx` Field/help presentation, `EssentialsPanel`, `EffectsPanel`, `RulesPanel`, TOML helpers and draft validation APIs. | React hover/focus/click/tap/Escape and viewport tests, inline error/save-status and no-input-mutation assertions, screen reader association, interaction/preservation tests, invalid type and priority errors, review/apply/export/reload and no implicit `priority = 0`. |
