...
public final class DefaultShowcaseStages {
    ...
    private static List<StageTemplate> stages() {
        return List.of(
            ...
            stage("showcase:templar", "Templar", "Master Paladin through shield control.", "minecraft:golden_helmet", List.of("showcase:paladin"), "all", 1, "Core paths", "#f0d06b", "challenge", itemAttribute("showcase:templar/health", "minecraft:shield", "minecraft:generic.max_health", 4.0, 325), grant("advancement", "minecraft:adventure/hero_of_the_village", 1) + reward("minecraft:gold_ingot:8", 6)),
            ...
            stage("showcase:arcane_archer", "Arcane Archer", "Merge Wizard and Marksman into mobile ranged magic.", "minecraft:tipped_arrow", List.of("showcase:wizard", "showcase:marksman"), "all", 2, "Hybrid paths", "#6aa9c8", "challenge", itemAttribute("showcase:arcane_archer/speed", "minecraft:bow", "minecraft:generic.movement_speed", 0.05, 431), grantWithItem("minecraft:phantom", "minecraft:bow", 12) + reward("minecraft:spectral_arrow:24", 6)),
            ...
            temporaryStage("showcase:aquatic_blessing", "Aquatic Blessing", "A temporary water breathing reward earned through the Tactical Fishing advancement.", "minecraft:heart_of_the_sea", List.of("showcase:ranger"), "Temporary power", "#4a9ac4", "20m", itemEffect("showcase:aquatic_blessing/breath", "minecraft:heart_of_the_sea", "minecraft:water_breathing", 0, 120, 812), grant("advancement", "minecraft:husbandry/tactical_fishing", 1)),
            ...
            stage("showcase:end_protocol", "End Protocol", "Earn final dimension access by crafting four End Crystals.", "minecraft:dragon_head", List.of("showcase:stronghold_key", "showcase:archmage"), "all", 2, "World rules", "#79649c", "challenge", temporaryRule("showcase:end_protocol/end_pickaxe", "allow", "items", "use", "minecraft:diamond_pickaxe", "dimension", "minecraft:the_end", 950), grant("craft", "minecraft:end_crystal", 4)),
