...
class ProgressiveStagesEMIPluginTest {
    ...
    void doesNotStartOrRunARefreshAfterTheClientWorldCloses() throws Exception {
        ...
        assertTrue(source.contains("private static final EmiReloadSessionGate reloadSessionGate"));
        ...
        assertTrue(source.contains("reloadSessionGate.claim(refreshGeneration, clientSessionGeneration.get(), clientDisconnecting.get())"));
        assertTrue(source.contains("!clientDisconnecting.get() && clientSessionGeneration.get() == refreshGeneration"));
