...
class EditorSchemaRegistryTest {
    ...
    void builtInSchemaCoversEveryRequiredEditorSurface() {
        List<String> required = List.of(
            ...
            "rules.toml:blocks.overrides",
            "rules.toml:recipes.locked_items",
            "rules.toml:recipes.locked_ids",
            ...
            "rules.toml:mobs.locked_spawns",
            "rules.toml:pets.locked_taming",
            "rules.toml:pets.locked_breeding",
            "rules.toml:pets.locked_commanding",
            "rules.toml:screens.locked",
            "rules.toml:trades.locked",
            "rules.toml:professions.locked",
            "rules.toml:advancements.locked",
            "rules.toml:curios.locked_slots",
